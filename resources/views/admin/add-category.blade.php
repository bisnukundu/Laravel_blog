        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" wire:submit.prevent="create" enctype="multipart/form-data" method="POST"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" wire:model.lazy="category" placeholder="Add Category"
